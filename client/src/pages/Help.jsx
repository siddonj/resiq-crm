...
const FAQS = [
  {
    ...
    items: [
      ...
      { q: 'What roles are available?', a: 'Admin — full access including user and settings management. Manager — can manage contacts, deals, and view all team members\' data. Rep — standard CRM access for sales representatives. Viewer — read-only. Roles are assigned when creating an account and can be changed later from Settings → Accounts.' },
